...
const articleTemplate = {
  id: '',              // 文章唯一ID（建议用数字字符串，如 '13'）
  title: '',           // 文章标题
  summary: '',         // 文章摘要（显示在卡片上）
  content: ``,         // 文章内容（支持 Markdown）
  type: '',            // 类型：tech | game | life | ai
  mood: '',            // 心情：从上面的 moods 数组中选一个 emoji
  tags: [],            // 标签数组，如 ['Vue3', '前端']
  createTime: '',      // 创建时间，格式：YYYY-MM-DD，如 '2026-05-09'
  views: 0,            // 浏览量（数字）
  pinned: false,       // 是否置顶（true | false）
  cover: '',           // 封面图片路径（可选，暂时留空）
}
*/
...
export const posts = [
  ...
  {
    id: '13',
    title: '✨ Markdown 渲染测试文章',
    summary: '测试 Markdown 各种语法的渲染效果，包括标题、列表、代码、引用等！',
    content: `# 欢迎测试 Markdown 渲染！

这是一篇专门用于测试 Markdown 各种语法效果的文章。
...
访问 [我的博客](https://github.com) 了解更多信息。

或者直接写链接：<https://github.com>

## 🌐 表格

| 功能 | 状态 | 说明 |
|------|------|------|
| Markdown 渲染 | ✅ 完成 | 支持所有基础语法 |
| 代码高亮 | 🚧 进行中 | 计划使用 Prism.js |
| 目录导航 | 📋 待办 | 自动生成文章目录 |
| 图片懒加载 | 💡 想法 | 提升页面加载速度 |
...
- [x] 更新 ArticleDetailView
- [ ] 添加更多 Markdown 功能
- [ ] 优化移动端显示

## 🎉 总结

这篇文章展示了 Markdown 的各种语法效果，包括：
...
6. **链接** - 普通链接、自动链接
7. **表格** - 清晰的数据展示
8. **任务列表** - GitHub 风格的复选框

现在你的博客已经支持完整的 Markdown 渲染了！🚀`,
    type: 'tech',
    mood: '🤩',
    tags: ['Markdown', '测试', '前端'],
  ...
  },
  {
    id: '1',
    title: '欢迎来到我的赛博日记本！🎉',
    summary: '从技术博客转型到碎碎念记录，这里会记录我折腾代码、玩游戏、以及跟AI发疯的日常~',
    content: `# 欢迎来到我的赛博日记本！
