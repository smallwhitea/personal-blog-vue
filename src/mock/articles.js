export const articles = [
  {
    ...
    summary: '深入了解 Vue3 Composition API，构建更加清晰、可复用的逻辑代码。',
...
配置 ESLint、Prettier、Husky 等工具保障代码质量。`,
    category: '工程化',
    tags: ['工程化', 'CI/CD', '前端'],
    author: '你的名字',
...
了解 Store、State、Getters、Actions 等基础概念。`,
    category: 'Vue3',
  ...
  },
  {
    ...
    summary: '路由配置、导航守卫、动态路由，一文带你掌握 Vue Router 4。',
    content: `# Vue Router 4 完整入门
...
配置基础路由、动态路由、嵌套路由。`,
  ...
  },
  {
    id: '7',
    title: '现代 CSS 布局技巧',
    summary: 'Flexbox、Grid 以及 Container Query 等现代 CSS 布局技术的应用。',
    content: `# 现代 CSS 布局技巧

## 1. 引言

现代 CSS 提供了强大的布局能力，本文介绍常用的布局技巧。`,
    category: 'CSS',
    tags: ['CSS', '布局', '响应式'],
    author: '你的名字',
  ...
  },
  {
    id: '8',
    title: '响应式设计最佳实践',
    summary: '从移动端优先到设计系统，完整的响应式设计方法论。',
    content: `# 响应式设计最佳实践

## 1. 引言

响应式设计让网站在各种设备上都能获得良好体验。`,
    category: '前端',
    tags: ['响应式', '设计', '前端'],
    author: '你的名字',
